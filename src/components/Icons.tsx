...
// Sidebar Requests Icon matching Images 1-4
export const RequestsNavIcon: React.FC<{ className?: string }> = ({
  className = 'w-5 h-5 text-blue-600',
}) => (
  <svg
    viewBox="0 0 24 24"
  ...
  >
    ...
    {/* Curved branch path connecting bottom-left up and right */}
    <path d="M6 15.8V10C6 7.79 7.79 6 10 6H15.8" />
    {/* Curved branch path connecting top-right down and left */}
    <path d="M18 8.2V14C18 16.21 16.21 18 14 18H8.2" />
  </svg>
);

// Sidebar Users Icon matching Images 1-4 (Three solid user heads with underline bar)
export const UsersNavIcon: React.FC<{ className?: string }> = ({
  className = 'w-5 h-5 text-blue-600',
}) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
    {/* Center person head */}
    ...
    {/* Center person body */}
    <path d="M7 16c0-2.8 2.2-5 5-5s5 2.2 5 5v1H7v-1z" />
    {/* Left person head */}
    <circle cx="6" cy="7.5" r="2.2" />
    {/* Left person body */}
    <path d="M2.5 16.5C2.5 14.2 4.2 12.5 6.2 12.2c-.2.5-.2 1-.2 1.6 0 1.2.5 2.2 1.2 3.2H2.5v-.5z" />
    {/* Right person head */}
    <circle cx="18" cy="7.5" r="2.2" />
    {/* Right person body */}
    <path d="M21.5 16.5c0-2.3-1.7-4-3.7-4.3.2.5.2 1 .2 1.6 0 1.2-.5 2.2-1.2 3.2h4.7v-.5z" />
    {/* Underline bar */}
